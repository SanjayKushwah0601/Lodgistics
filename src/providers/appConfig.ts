...
export let createBroadCastConfirmMsg = "Do you want to broadcast this message?";
export let cancelBroadcastConfirmMsg = "Do you want to cancel broadcast this message?";
...
export let appCurrentVersion = "1.1.0";
