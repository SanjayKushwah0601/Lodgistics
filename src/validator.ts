...
export namespace Validator {
  ...
  export const feedCreateValidator = ['', [Validators.required]];
  export const groupCreateValidator = ['', [Validators.required]];
  export const loginEmailValidator = ['', [Validators.required]];


  export const hotelNameValidator = ['', [Validators.required]];
  export const userTitleValidator = ['', [Validators.required]];
  export const hotelEmailValidator = ['', [
    Validators.required,
    Validators.pattern('^[a-zA-Z0-9]+(\.[_a-zA-Z0-9]+)*@[a-zA-Z0-9-]+(\.[a-zA-Z0-9-]+)*(\.[a-zA-Z]{2,15})$')
  ]];
  export const hotelPasswordValidator = ['', [Validators.required]];
